...
par(mfrow = c(2,2))
plot(data5$DateStamp,data5$Global_active_power, xlab = "", ylab = "Global Active Power (killowatts)", type = "l")
plot(data5$DateStamp, data5$Voltage, xlab = "datetime", ylab = "Voltage", type = "l")
...
plot(data5$DateStamp,data5$Global_reactive_power, xlab = "datetime", ylab = "Global_reactive_power", type = "l")
dev.off()